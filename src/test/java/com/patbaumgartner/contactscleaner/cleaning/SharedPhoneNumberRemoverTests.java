...
class SharedPhoneNumberRemoverTests {
	...
	private static CleaningProperties enabled(int threshold) {
		return new CleaningProperties(true, "", true, false, false, true, true, true, false, true, true, true, true,
				true, true, true, false, true, true, true, java.util.List.of("Age"), java.util.List.of(), true, true,
				true, true, threshold, false, false);
	}
	...
	void removesNumbersSharedByThresholdManyContacts() {
		...
		VCard first = contact("Colleague One", "+41712286788", "+41791111111");
		VCard second = contact("Colleague Two", "+41712286788");
		VCard third = contact("Colleague Three", "+41712286788", "+41792222222");
	...
	void disabledByDefault() {
		...
		List<VCard> office = List.of(contact("A", "+41712286788"), contact("B", "+41712286788"),
				contact("C", "+41712286788"));
