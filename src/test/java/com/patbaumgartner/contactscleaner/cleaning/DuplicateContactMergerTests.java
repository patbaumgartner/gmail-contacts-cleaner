...
class DuplicateContactMergerTests {
	...
	void mergesFlippedNamesSharingAPhoneNumber() {
		VCard rich = contact("Max Muster", "+41790000001", "max@example.com");
		VCard poor = contact("Muster Max", "+41790000001", null);
		...
		assertThat(rich.getTelephoneNumbers()).extracting(Telephone::getText).containsExactly("+41790000001");
	}

	@Test
	void mergesIdenticalNamesSharingAnEmail() {
		VCard first = contact("Jane Doe", null, "jane.doe@example.com");
		VCard second = contact("Jane Doe", "+49300000001", "jane.doe@example.com");
		...
		assertThat(second.getEmails()).extracting(Email::getValue).containsExactly("jane.doe@example.com");
	}
	...
	void neverMergesSharedValueWithDifferentNames() {
		...
		VCard first = contact("Jane Doe", "+41440000001", null);
		VCard second = contact("Max Muster", "+41440000001", null);
	...
	void disabledByDefault() {
		...
		VCard first = contact("Max Muster", "+41790000001", null);
		VCard second = contact("Muster Max", "+41790000001", null);
