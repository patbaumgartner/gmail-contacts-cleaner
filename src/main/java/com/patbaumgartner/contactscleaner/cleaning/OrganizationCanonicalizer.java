 ...
 * leave the same employer in half a dozen variants — {@code Namics}, {@code Namics AG},
 * {@code namics AG}, {@code Namics GmbH} — which breaks searching and grouping by
 * company.
 *
 * <p>
...
public class OrganizationCanonicalizer {
	...
	/** "Namics AG." / "namics GmbH" / "Namics, Inc." → "namics". */
